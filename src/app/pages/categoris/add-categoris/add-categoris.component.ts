...
import { catInfo } from '../data/categori-info';
...
@Component({
  ...
  templateUrl: './add-categoris.component.html',
  styleUrls: ['./add-categoris.component.scss'],
...
export class AddCategorisComponent implements OnInit {
  ...
  getAllCat(){ // get all categori function from cat.servics
   ...
   fileEvent(e){
    ...
    addCategori() { // add categori function from cat.servics
